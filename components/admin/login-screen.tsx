        ...
        <CardContent className="space-y-4">
          {!configured ? (
            <div className="flex gap-3 rounded-lg border border-border bg-secondary/40 p-3 text-sm text-muted-foreground">
              ...
              <p>
                Falta configurar Firebase. Copiá <code className="text-foreground">.env.local.example</code> a{" "}
                <code className="text-foreground">.env.local</code> y completá las variables{" "}
